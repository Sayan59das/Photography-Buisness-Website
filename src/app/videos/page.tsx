    ...
    <div className="min-h-screen bg-background pt-16">
      ...
      <section className="py-20 md:py-32 px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Immerse yourself in our cinematic short films and highlight reels. We don't just record video; we direct a movie of your life.
        </p>
      </section>

      {/* Featured Video */}
      <section className="px-6 lg:px-8 pb-16 max-w-[1400px] mx-auto">
        <div className="relative w-full aspect-video rounded-3xl overflow-hidden group cursor-pointer">
          {/* Replace with actual video player or iframe later */}
          <div 
      ...
      <section className="px-6 lg:px-8 pb-32 max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {videos.map((video) => (
            <div key={video.id} className="relative aspect-video rounded-2xl overflow-hidden group cursor-pointer">
              <div 
