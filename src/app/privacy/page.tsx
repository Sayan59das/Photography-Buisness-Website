    ...
    <div className="min-h-screen bg-background pt-24 pb-32">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg dark:prose-invert prose-headings:font-heading prose-headings:font-bold prose-a:text-primary max-w-none">
          <p>
            At STUDIO, we are committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by STUDIO.
          </p>
          ...
          <p>
            As a photography studio, images captured during our sessions are copyrighted by STUDIO. We reserve the right to use these images for portfolio, marketing, and promotional purposes unless a non-disclosure agreement (NDA) or privacy clause is explicitly agreed upon prior to the shoot.
          </p>
